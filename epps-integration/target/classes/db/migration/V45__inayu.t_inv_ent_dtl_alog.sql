-- FUNCTION: inayu.t_inv_ent_dtl_alog()

-- DROP FUNCTION inayu.t_inv_ent_dtl_alog();
...
GRANT EXECUTE ON FUNCTION inayu.t_inv_ent_dtl_alog() TO PUBLIC;
