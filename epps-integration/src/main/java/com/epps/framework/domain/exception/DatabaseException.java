...
public class DatabaseException extends RuntimeException implements ILogOnce{
	...
	public DatabaseException(final String message, final ErrorCode code, ResponseInfoType errorType) {
		this.setMessage(message);
		this.errorCode = code;
		this.errorType = errorType;
	}

	public DatabaseException(final String message, final ErrorCode code, final Throwable throwable, ResponseInfoType errorType) {
		super(throwable);
		this.errorCode = code;
		this.setMessage(message);
		this.errorType = errorType;
