...
public class ApplicationException extends RuntimeException implements ILogOnce{
	...
	public ApplicationException(final String message, final ErrorCode code, ResponseInfoType errorType) {
		this.setMessage(message);
		this.errorCode = code;
		this.errorType = errorType;
	}

	public ApplicationException(final String message, final ErrorCode code, final Throwable throwable, ResponseInfoType errorType) {
		super(throwable);
		this.errorCode = code;
		this.setMessage(message);
		this.errorType = errorType;
