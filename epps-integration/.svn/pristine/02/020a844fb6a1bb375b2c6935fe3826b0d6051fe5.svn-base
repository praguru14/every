...
public class ProcedureException extends RuntimeException implements ILogOnce{
	...
	public ProcedureException(final String message, final ErrorCode code, ResponseInfoType errorType) {
		this.setMessage(message);
		this.errorCode = code;
		this.errorType = errorType;
	}

	public ProcedureException(final String message, final ErrorCode code, final Throwable throwable, ResponseInfoType errorType) {
		super(throwable);
		this.errorCode = code;
		this.setMessage(message);
		this.errorType = errorType;
